...
export default function Tracks({ params }: { params: { id: string } }) {
    ...
    const { album, tracks, loading, error, fetchAlbumDetails } = useCarouselStore();
    ...
    if (loading) return <TracksSekeleton />;
                                ...
                                <div className="mt-auto flex flex-col gap-6 items-start">
                                    ...
                                    <div className="flex gap-6">
                                        <div className="mt-auto space-y-2">
                                            <div className="text-base md:text-xl text-white">{album.artistName}</div>

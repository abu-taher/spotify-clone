...
function RecentSearches() {
    const recentSearch = [
        {
            imageSrc: '/album-art2@2x.png',
            name: 'The Chainsmokers',
            category: 'Artist'
        },
        {
            imageSrc: '/album-art-11@2x.png',
            name: 'Ed Sheeran',
            category: 'Artist'
        },
    ];
        ...
        <>
            <div className='hidden lg:block mt-[46px] px-4 lg:px-10'>
                <div className='flex justify-between mb-7'>
                    <h2 className='text-[1.188rem] md:text-[1.625rem] lg:text-[2rem] text-white tracking-[-0.05em] font-bold'>Recent Searches</h2>
                    ...
                    {recentSearch.map((recent, index) => (
                        <div key={index} className=' rounded-lg bg-gray-1400 transition hover:bg-gray-1500 hover:transition pt-5 px-5 pb-7 cursor-pointer overflow-hidden group'>
                            <div className='relative'>
                                {/* CANCEL BUTTON */}
                                <button className=' absolute top-0 right-0'><svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" className="w-5 h-5 fill-white"><path d="M2.47 2.47a.75.75 0 0 1 1.06 0L8 6.94l4.47-4.47a.75.75 0 1 1 1.06 1.06L9.06 8l4.47 4.47a.75.75 0 1 1-1.06 1.06L8 9.06l-4.47 4.47a.75.75 0 0 1-1.06-1.06L6.94 8 2.47 3.53a.75.75 0 0 1 0-1.06Z" /></svg></button>
                                <Image
                                    src={recent.imageSrc}
                                    width={364}
                                    height={364}
                            ...
                            <h5 className='self-stretch relative tracking-[0.03em] text-base md:text-xl text-white line-clamp-2 font-bold mb-2'>{recent.name}</h5>
                            <h6 className='self-stretch relative text-base md:text-[1.125rem] md:leading-[1.278rem] text-darkgray-100 line-clamp-2'>{recent.category}</h6>
                        </div>

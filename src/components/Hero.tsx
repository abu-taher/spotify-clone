  ...
  return (
    <div className='px-4 lg:px-10'>
      ...
      <header className='py-6 flex items-center justify-between'>
        ...
        {/* RIGHT USER */}
        <div>
          <div className="rounded-full bg-gray-900 flex flex-row items-start justify-start pt-[0.187rem] pb-[0.187rem] pl-[0.187rem] pr-2.5 box-border gap-[0.687rem] z-[1] cursor-pointer">
            <Image
            ...
            <div className="flex flex-col items-start justify-start pt-[0.343rem] px-[0rem] pb-[0rem]">
              <button className="[text-decoration:none] relative tracking-[0.01em] font-bold text-white inline-block min-w-[6.375rem]">
                davedirect3
              </button>
            </div>
                    ...
                    >
                      ...
                      <div className='absolute right-5 w-[62px] h-[62px] flex cursor-pointer opacity-0 transition group-hover:opacity-100 group-hover:transition'>
                        <button className='w-[62px] h-[62px] rounded-full bg-lightgreen flex items-center justify-center shadow-[0px_8px_8px_rgba(0,0,0,.3)]'>
                          <svg data-encore-id="icon" aria-hidden="true" viewBox="0 0 24 24" className=' w-7 h-[30px]'>

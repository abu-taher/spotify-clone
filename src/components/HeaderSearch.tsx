    ...
    return (
        <>
            <div className='sticky top-0 z-50 text-white px-4 lg:px-10 pt-9 pb-5 lg:py-3.5 bg-black flex flex-col lg:flex-row items-start lg:items-center justify-between'>
                <h3 className='lg:hidden text-white text-[2rem] font-bold mb-4'>Search</h3>
                {/* SEARCH INPUT */}
                <form className='max-w-[468px] w-full relative'>
                    <svg data-encore-id="icon" role="img" aria-hidden="true" className=' w-6 lg:w-8 h-6 lg:h-8 fill-gray-500 absolute left-4 top-1/2 -translate-y-1/2' viewBox="0 0 16 16"><path d="M7 1.75a5.25 5.25 0 1 0 0 10.5 5.25 5.25 0 0 0 0-10.5zM.25 7a6.75 6.75 0 1 1 12.096 4.12l3.184 3.185a.75.75 0 1 1-1.06 1.06L11.304 12.2A6.75 6.75 0 0 1 .25 7z" /></svg>
                    <input className='bg-white rounded-full w-full h-11 lg:h-[52px] text-black text-lg font-medium placeholder:text-gray-200 pl-12 lg:pl-[62px] pr-4 focus-visible:outline-none' placeholder='Artists, songs, or podcasts' />
                </form>
                {/* RIGHT USER */}
